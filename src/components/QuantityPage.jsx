...
export default function QuantityPage({ events }) {
  ...
  const handleSubmit = (e) => {
    ...
    // Navigate to your payment page with quantity in query params
    navigate(`/detailsPage/paymentDetails/${event._id}?quantity=${quantity}`);
  };
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <form
        ...
        onSubmit={handleSubmit} // use React navigation
      >
        <label
        ...
        <button
          type="submit"
          className="inline-block px-6 py-2 text-white font-semibold rounded bg-[#98430e] hover:opacity-90 transition curosor-pointer"
        >
          Continue
        </button>
      </form>
