...
// // The 'api' import is not used, you can remove it if it's not needed elsewhere.

// export default function AdminLogin() {
//   // ✅ All hooks should be at the top level of the component.
...
//   // ✅ The handleSubmit function should also be at the top level.
...
//         // ✅ store role + token in AuthContext
//         login(data.role, data.token);

//         navigate("/admin/uploadEvents");
//       }
//     } catch (err) {
...
//   // The return part (JSX) is correct and doesn't need changes.
//   return (
...
//         {/* This form now correctly points to the handleSubmit function above */}
